...
exports.test = function (req, res) {
    res.send({
        status: "success",
        message: "Greetings from the User controller!",
    });
};
    ...
    User.find(
        ...
        function (err, doc) {
            if (err) {
                ...
                if (doc)
                    res.send({ status: "success", message: "User found", data: doc });
...
exports.user_view_by_id = function (req, res) {
...
exports.user_edit_by_id = function (req, res) {
    utils.checkAdmin(req, res, (req, res) => {
        User.findOneAndUpdate(
            { _id: req.params.id },
            { ...req.body.user },
    ...
    User.findOneAndUpdate(
        ...
        function (err) {
            if (err) {
                ...
                res.send({
                    status: "success",
                    message: "Cleared all notifications. Login again",
                });
            }
        }
    );
